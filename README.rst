...
.. code:: bash
    ...
    pip install "git+https://github.com/AdiEcho/steam#egg=steam"

    # specific version tag (e.g. v1.0.0)
    pip install "git+https://github.com/AdiEcho/steam@v1.0.0#egg=steam[client]"
    # without SteamClient extras
    pip install "git+https://github.com/AdiEcho/steam@v1.0.0#egg=steam"
